...
const quitPopupEdit = document.querySelector('.popup_close-edit');
const quitPopupAdd = document.querySelector('.popup_close-add');
const quitPopupEnlager = document.querySelector('.popup_close-enlager');
